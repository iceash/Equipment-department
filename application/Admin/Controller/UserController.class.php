...
class UserController extends AdminbaseController{
	...
	function userinfo_post(){
		if (IS_POST) {
			...
			->field("user_login,user_email,department_namelast_login_ip,last_login_time,create_time,user_activation_key,user_status,role_id,score,user_type",true)//排除相关字段
			->create();
			if ($create_result) {
