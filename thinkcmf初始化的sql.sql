...
-- 导出 thinkcmf 的数据库结构
CREATE DATABASE IF NOT EXISTS `thinkcmf` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `thinkcmf`;


-- 导出  表 thinkcmf.cmf_ad 结构
...
-- 正在导出表  thinkcmf.cmf_auth_access 的数据：5 rows
/*!40000 ALTER TABLE `cmf_auth_access` DISABLE KEYS */;
INSERT IGNORE INTO `cmf_auth_access` (`role_id`, `rule_name`, `type`) VALUES
...
-- 导出  表 thinkcmf.cmf_auth_rule 结构
...
) ENGINE=MyISAM AUTO_INCREMENT=163 DEFAULT CHARSET=utf8 COMMENT='权限规则表';

-- 正在导出表  thinkcmf.cmf_auth_rule 的数据：162 rows
/*!40000 ALTER TABLE `cmf_auth_rule` DISABLE KEYS */;
INSERT IGNORE INTO `cmf_auth_rule` (`id`, `module`, `type`, `name`, `param`, `title`, `status`, `condition`) VALUES
	...
	(162, 'Demo', 'admin_url', 'demo/admin/index', NULL, 'Demo菜单', 1, '');
/*!40000 ALTER TABLE `cmf_auth_rule` ENABLE KEYS */;


-- 导出  表 thinkcmf.cmf_comments 结构
...
-- 正在导出表  thinkcmf.cmf_links 的数据：1 rows
/*!40000 ALTER TABLE `cmf_links` DISABLE KEYS */;
INSERT IGNORE INTO `cmf_links` (`link_id`, `link_url`, `link_name`, `link_image`, `link_target`, `link_description`, `link_status`, `link_rating`, `link_rel`, `listorder`) VALUES
	(1, 'http://www.thinkcmf.com', 'ThinkCMF', '', '_blank', '', 1, 0, '', 0);
/*!40000 ALTER TABLE `cmf_links` ENABLE KEYS */;


-- 导出  表 thinkcmf.cmf_menu 结构
CREATE TABLE IF NOT EXISTS `cmf_menu` (
  ...
  KEY `model` (`model`)
) ENGINE=MyISAM AUTO_INCREMENT=163 DEFAULT CHARSET=utf8 COMMENT='后台菜单表';

-- 正在导出表  thinkcmf.cmf_menu 的数据：162 rows
/*!40000 ALTER TABLE `cmf_menu` DISABLE KEYS */;
INSERT IGNORE INTO `cmf_menu` (`id`, `parentid`, `app`, `model`, `action`, `data`, `type`, `status`, `name`, `icon`, `remark`, `listorder`) VALUES
	...
	(162, 0, 'Demo', 'Admin', 'index', '', 1, 1, 'Demo菜单', '', '', 100);
/*!40000 ALTER TABLE `cmf_menu` ENABLE KEYS */;


-- 导出  表 thinkcmf.cmf_nav 结构
...
-- 正在导出表  thinkcmf.cmf_nav 的数据：3 rows
/*!40000 ALTER TABLE `cmf_nav` DISABLE KEYS */;
INSERT IGNORE INTO `cmf_nav` (`id`, `cid`, `parentid`, `label`, `target`, `href`, `icon`, `status`, `listorder`, `path`) VALUES
...
-- 正在导出表  thinkcmf.cmf_nav_cat 的数据：1 rows
/*!40000 ALTER TABLE `cmf_nav_cat` DISABLE KEYS */;
INSERT IGNORE INTO `cmf_nav_cat` (`navcid`, `name`, `active`, `remark`) VALUES
	(1, '主导航', 1, '主导航');
/*!40000 ALTER TABLE `cmf_nav_cat` ENABLE KEYS */;


-- 导出  表 thinkcmf.cmf_oauth_user 结构
...
-- 正在导出表  thinkcmf.cmf_options 的数据：2 rows
/*!40000 ALTER TABLE `cmf_options` DISABLE KEYS */;
INSERT IGNORE INTO `cmf_options` (`option_id`, `option_name`, `option_value`, `autoload`) VALUES
...
-- 正在导出表  thinkcmf.cmf_posts 的数据：1 rows
/*!40000 ALTER TABLE `cmf_posts` DISABLE KEYS */;
INSERT IGNORE INTO `cmf_posts` (`id`, `post_author`, `post_keywords`, `post_source`, `post_date`, `post_content`, `post_title`, `post_excerpt`, `post_status`, `comment_status`, `post_modified`, `post_content_filtered`, `post_parent`, `post_type`, `post_mime_type`, `comment_count`, `smeta`, `post_hits`, `post_like`, `istop`, `recommended`) VALUES
	(1, 3, '', '', '2016-05-29 16:10:47', '<p>为计划开发和未可厚非客家文化副科级</p>', '测试', '请问地区稳定', 1, 1, '2016-05-29 16:10:22', NULL, 0, NULL, '', 0, '{"thumb":""}', 1, 0, 0, 0);
/*!40000 ALTER TABLE `cmf_posts` ENABLE KEYS */;


-- 导出  表 thinkcmf.cmf_role 结构
...
-- 正在导出表  thinkcmf.cmf_role 的数据：2 rows
/*!40000 ALTER TABLE `cmf_role` DISABLE KEYS */;
INSERT IGNORE INTO `cmf_role` (`id`, `name`, `pid`, `status`, `remark`, `create_time`, `update_time`, `listorder`) VALUES
	(1, '超级管理员', 0, 1, '拥有网站最高管理员权限！', 1329633709, 1329633709, 0),
	(2, '123', NULL, 1, '测试', 1464509270, 0, 0);
/*!40000 ALTER TABLE `cmf_role` ENABLE KEYS */;


-- 导出  表 thinkcmf.cmf_role_user 结构
...
-- 正在导出表  thinkcmf.cmf_role_user 的数据：1 rows
/*!40000 ALTER TABLE `cmf_role_user` DISABLE KEYS */;
INSERT IGNORE INTO `cmf_role_user` (`role_id`, `user_id`) VALUES
	(2, 3);
/*!40000 ALTER TABLE `cmf_role_user` ENABLE KEYS */;


-- 导出  表 thinkcmf.cmf_route 结构
...
-- 正在导出表  thinkcmf.cmf_terms 的数据：2 rows
/*!40000 ALTER TABLE `cmf_terms` DISABLE KEYS */;
INSERT IGNORE INTO `cmf_terms` (`term_id`, `name`, `slug`, `taxonomy`, `description`, `parent`, `count`, `path`, `seo_title`, `seo_keywords`, `seo_description`, `list_tpl`, `one_tpl`, `listorder`, `status`) VALUES
...
-- 导出  表 thinkcmf.cmf_term_relationships 结构
...
-- 正在导出表  thinkcmf.cmf_term_relationships 的数据：1 rows
/*!40000 ALTER TABLE `cmf_term_relationships` DISABLE KEYS */;
INSERT IGNORE INTO `cmf_term_relationships` (`tid`, `object_id`, `term_id`, `listorder`, `status`) VALUES
	(1, 1, 2, 0, 1);
/*!40000 ALTER TABLE `cmf_term_relationships` ENABLE KEYS */;


-- 导出  表 thinkcmf.cmf_users 结构
...
-- 正在导出表  thinkcmf.cmf_users 的数据：3 rows
/*!40000 ALTER TABLE `cmf_users` DISABLE KEYS */;
INSERT IGNORE INTO `cmf_users` (`id`, `user_login`, `user_pass`, `user_nicename`, `user_email`, `user_url`, `avatar`, `sex`, `birthday`, `signature`, `last_login_ip`, `last_login_time`, `create_time`, `user_activation_key`, `user_status`, `score`, `user_type`, `coin`, `mobile`) VALUES
	(1, 'admin', '###fbbe5d57473d11011f75f8ec2a3def0d', 'admin', '414798080@qq.com', '', NULL, 0, NULL, NULL, '127.0.0.1', '2016-05-30 15:59:27', '2016-05-19 09:51:46', '', 1, 0, 1, 0, ''),
	(2, '123_qq_com', '###feb68ac79adffe6c5fdf51cbb4f74159', '123_qq_com', '123@qq.com', '', NULL, 0, NULL, NULL, '127.0.0.1', '2016-05-19 10:37:15', '2016-05-19 10:37:15', '', 1, 0, 2, 0, ''),
	(3, '123', '###5f71411a4466a427c6e2d3d281303e16', '', '124124125@qq.com', '', NULL, 0, NULL, NULL, '127.0.0.1', '2016-05-29 16:10:11', '2016-05-29 16:09:16', '', 1, 0, 1, 0, '');
/*!40000 ALTER TABLE `cmf_users` ENABLE KEYS */;


-- 导出  表 thinkcmf.cmf_user_favorites 结构
...
-- 正在导出表  thinkcmf.cmf_user_favorites 的数据：0 rows
